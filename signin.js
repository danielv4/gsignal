...
this.signinHTML = function () {
		...
		<div class="g-menu-login-43847" >
			<div class="g-menu-next-g-43847" >
				...
				<div class="g-menu-next-yg-43847" >
					<div class="g-menu-input-t-67486" >Users name or Email</div>
					<input id="m-value" class="g-menu-input-67486" type="text" placeholder="example@email.com" />
					<div class="g-menu-input-t-67486" >Password</div>
					<input id="m-password" class="g-menu-input-67486" type="Password" placeholder="" />
					<div class="g-menu-p-t-67486" >Forgot password ?</div>
					<div id="login-button" class="g-menu-button-t-67486" >
						<div class="g-menu-button-t-i-67486" >Sign in</div>
					</div>
					<div class="g-menu-span-t-67486" >
						<div class="g-menu-span-t-d-67486" >
							<div class="g-menu-span-t-m-67486" ></div>
						</div>
						<div class="g-menu-span-t-i-67486" >or</div>
						<div class="g-menu-span-t-d-67486" >
							<div class="g-menu-span-t-m-67486" ></div>
						</div>
					</div>
					<div class="g-menu-auth-gmail-67486" >
						<div class="g-menu-auth-67486" >
							<img class="g-menu-auth-i-67486" src="icon/sign-in.png" />
						</div>	
						<div class="g-menu-auth-text-67486" >Sign in with Google</div>
					</div>
				</div>
				<div class="g-menu-footer-67486" >
					<div class="g-menu-footer-t1-67486" >New GSignal?</div>
					<div id="m-redirect" class="g-menu-footer-t2-67486" >Create Account</div>
				</div>
			</div>
		</div>
	</div>
	...
	$(document).ready(function(){
		...
		$("#login-button").click(function() {
			...
			var g_user_or_email = $("#m-value").val();
			var g_password = $("#m-password").val();
				
			var obj = {
				"type":"signin",
				"user_or_email":g_user_or_email,
				"password":g_password
			};
